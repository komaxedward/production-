...
app.config['SQLALCHEMY_DATABASE_URI'] = os.environ.get('postgresql://inventory_db_eumg_user:kwmJInxZnrEBwfBrlxF96LjUCoAFYtj5@dpg-ctkg2ibqf0us739hnutg-a/inventory_db_eumg')  # Use environment variable
